...
def voltar_menu_principal():
    '''Função responsável em voltar ao menu principal'''
...
def exibir_subtitulo(texto):
    '''Exibir título das opções escolhidas'''
...
def listar_restaurantes():
    '''Função responsável por listar um novo restaurante'''
...
def alterar_estado_restaurante():
    '''Função responsável por alterar o estado do restaurante'''
...
def escolher_opcoes():
    '''Função responsável em exibir as opções para o usuário'''
